...
Ext.define('smiley360.view.Details', {
	...
	setMissionDetails: function () {
		...
		if (detailsArray.mission_shipment_active == '1') {
			Ext.getCmp('xDetailsShipment').setHtml('Your packgage will ship ' + detailsArray.mission_shipment_message);//detailsArray.promo_message);
		}
		else {
		...
		for (var key in smilesArray) {
			...
			this.setSmileItem(oneItem.sharingTool_name, oneItem.sharingTool_current_smiles + '/' + oneItem.sharingTool_max_smiles, 'padding: 5px 15px;');

		};
		this.setSmileItem('Bonus', pointsArray.mission_bonus_smiles, 'padding: 5px 15px;');
		this.setSmileItem('Mission Total', pointsArray.mission_current_smiles + '/' + pointsArray.mission_max_smiles, 'padding: 5px 15px; font-weight: bold;');
		this.setSmileItem('Total Smiles', pointsArray.mission_total_smiles, 'padding: 5px 15px;');
